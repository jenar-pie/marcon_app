  ...
  static final List<Map<String, dynamic>> globalActivities = [
    {
      ...
      'marketing': 'Budi S',
      'lokasi': 'Jl. Swadarma Raya Kampung Baru, Jakarta Selatan',
      'checkIn': '08.30',
      'checkOut': '10.02',
      'durasi': '48 menit',
      'notulensi':
    ...
    },
    {
      ...
      'marketing': 'cantika',
      'lokasi': 'Jl. Garnisun Kav 2-3, Jakarta Selatan',
      'checkIn': '09.15',
      'checkOut': '11.00',
      'durasi': '105 menit',
    ...
    },
    {
      ...
      'lokasi': 'Jl. Diponegoro No.71, Jakarta Pusat',
      'checkIn': '15.10',
      'checkOut': '16.00',
      'durasi': '50 menit',
    ...
    },
    {
      ...
      'jenis': 'Meeting',
      'customer': 'RS Siloam Hospitals',
      'hasil': 'Negosiasi Harga',
      'nextAction': 'Kirim Kontrak',
      'marketing': 'Budi S',
      'lokasi': 'Siloam Hospitals TB Simatupang',
      'checkIn': '10.00',
      'checkOut': '11.30',
      'durasi': '90 menit',
    ...
    },
    {
      ...
      'jenis': 'Kunjungan',
      'customer': 'RSUP Dr. Cipto Mangunkusumo',
      'hasil': 'Demo Alat Medis',
      'nextAction': 'Follow Up Trial',
      'marketing': 'cantika',
      'lokasi': 'Gedung A RSCM Jakarta Pusat',
      'checkIn': '13.45',
      'checkOut': '15.45',
      'durasi': '120 menit',
